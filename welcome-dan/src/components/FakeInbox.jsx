...
const EMAILS = [
  ...
  {
    id: 2, from: 'Leif Johnson', email: 'ljohnson@structurecraft.com',
    subject: 'Quick one', time: 'Mon 9:15 AM', unread: true,
  ...
  },
  {
    ...
    subject: 'Your first week', time: 'Mon 9:47 AM', unread: true,
    body: 'Dan \u2014 I\'ve set up your Notion access, HubSpot login, and Teams account. InDesign templates are in the shared drive (I\'ll walk you through them tomorrow). Also, the P: drive VPN is... an experience. Let me know if it gives you trouble. See you Monday morning.',
  },
  {
    id: 4, from: 'SC IT', email: 'it@structurecraft.com',
    subject: 'Account Setup Complete', time: 'Mon 10:00 AM', unread: true,
  ...
  },
  {
    ...
    subject: 'RFP \u2014 Cascade Mixed-Use Development', time: 'Mon 2:30 PM', unread: true,
  ...
  },
  {
    ...
    subject: 'RE: RFP \u2014 Cascade Mixed-Use Development', time: 'Mon 3:12 PM', unread: true,
